...
#+begin_src shell :results raw drawer :exports none
npm install
#+end_src
...
const drawMazeTask = () => {
    ...
    canvas.createPNGStream().pipe(
        fs.createWriteStream('../../assets/images/maze-manual/maze-task.png')
    )
}
...
const drawMazeTagged = () => {
    ...
    tagMaze(ctx)
    canvas.createPNGStream().pipe(
        fs.createWriteStream('../../assets/images/maze-manual/maze-tagged.png')
    )
}
...
const drawMazePath = () => {
    ...
    pathMaze(ctx)
    canvas.createPNGStream().pipe(
        fs.createWriteStream('../../assets/images/maze-manual/maze-path.png')
    )
}
drawMazeTask()
drawMazeTagged()
...
return '../../assets/images/maze-manual/maze-path.png'
#+end_src

#+results:
[[file:../../assets/images/maze-manual/maze-path.png]]

#+begin_src dot :file ../../assets/images/maze-manual/maze-graph.png :cmdline -Kdot -Tpng
digraph {
  Вход
  Выход
  Азел  [color="green"]
...
#+begin_src dot :file ../../assets/images/maze-manual/maze-graph-path.png :cmdline -Kdot -Tpng
digraph {
  Вход
  Выход
  Азел  [color="green"]
...
#+results:
[[file:../../assets/images/maze-manual/maze-graph-path.png]]
